...
//....................        add reviewInfo in reviews child
      ...
      // let tdata : [String : Any] = ["averageStar": String(roundAvStar),
        ...
        let mutipleData = ["ReviewInfo/\(rid)": reviewData,
                           ...
                           "ToiletUserList/\(toilet.key)/averageStar": String(roundAvStar),
                           "ToiletUserList/\(toilet.key)/averageWait": newWaitingTime as Int,
                           "ToiletUserList/\(toilet.key)/reviewCount": newReviewCount as Int,
